...
def main():
    ...
    print(os.path.dirname(__file__)) # con os.path.dirname(__file__) le estoy diciendo que me diga la ruta a este fichero
    
    # Get the settings fullpath 
    settings_file = os.path.dirname(__file__) + "\\settings.json" # al concatenar esto, que es el nombre
    #del fichero le doy la ruta hasta el fichero json
    # Load json from file 
